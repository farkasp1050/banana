...
<header>
    <nav>
        <ul>
            ...
            <li>
                <a aria-current="page" href="kurzusra_jelentkezes.php">Kurzusra jelentkezés</a>
            </li>
            <li>
                <a href="vizsgara_jelentkezes.php">Vizsgára jelentkezés</a>
            </li>
            <li>
    ...
    <div id="alap">
        <div id="baloszlop">
            <p id="focimszoveg">Válasszon<br>kurzusokat.</p>
        </div>
        <div id="focimkep">
