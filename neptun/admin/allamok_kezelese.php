...
<header>
    <nav>
        <ul>
            ...
            <li>
                <a aria-current="page" href="allamok_kezelese.php">Államok kezelése</a>
            </li>
            <li>
    ...
    <div id="alap">
        <div id="baloszlop">
            <p id="focimszoveg">Államok<br>módosítása.</p>
        </div>
        <div id="focimkep">
...
<main>
    ...
    <table class="lista_tablazat">
        <tr>
            <td>Állam hozzáadása.</td>
            <td><a href="allam_hozzaadasa.php">Megtekintés</a></td>
        </tr>
        <tr>
            <td>Államok módosítása, törlése.</td>
            <td><a href="allamok_modositasa_torlese.php">Megtekintés</a></td>
        </tr>
