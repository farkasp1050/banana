...
<main>
    <div id="registration_hallgato_by_admin">
        <h1>Hallgató hozzáadása</h1>
        <form method="POST" action="add_hallgato_connect.php" accept-charset="utf-8">
            <p>@stud.hu</p>
            ...
            <input id=regisztracio type="submit" value="Regisztrálás" name="elkuld"/><br>
